...
## [3.6.0-beta.3](https://github.com/BEagle1984/silverback/releases/tag/v3.6.0-beta.3)
...
* Add overload for `Publish` method in error policies that fowards the exception that triggered the error policy
